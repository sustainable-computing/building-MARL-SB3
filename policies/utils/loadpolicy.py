...
def load_policy_library(policy_library_path: str, policy_type: str,
    ...
    for policy_path in policy_paths:
        policy = load_policy(policy_path, policy_type, init_log_std, init_log_std_path,
                             eval_mode, device)
...
def initialize_policy(policy, policy_type, obs_size, action_size, init_log_std, device):
